    ...
    <div class="row">
        ...
        <div class="col-12">
            <p>
                ...
                across desktop and mobile web browsers. Games can be compiled to iOS, Android and native apps by using
                3rd party tools. You can use JavaScript or TypeScript for development.
            </p>
            <p>
                Along with the fantastic open source community, Phaser is actively developed and maintained by <a href="http://www.photonstorm.com">Photon Storm</a>. As a result of rapid support, and a developer
                friendly API, Phaser is currently one of the <a href="https://github.com/collections/javascript-game-engines">most starred</a> game frameworks on GitHub.
            </p>
            <p>
                Thousands of developers from indie and multi-national digital agencies, and universities worldwide use Phaser. You can take a look at their incredible <a href="https://phaser.io/games/">games</a>.
            </p>
            <p>
                <strong>Visit:</strong> The <a href="https://phaser.io">Phaser website</a> and follow on <a href="https://twitter.com/phaser_">Phaser Twitter</a>
                <strong>Play:</strong> Some of the amazing games <a href="https://twitter.com/search?q=%23madewithphaser&amp;src=typed_query&amp;f=live">#madewithphaser</a><br />
                <strong>Learn:</strong> <a href="https://photonstorm.github.io/phaser3-docs/index.html">API Docs</a>, <a href="https://phaser.discourse.group/">Support Forum</a> and <a href="https://stackoverflow.com/questions/tagged/phaser-framework">StackOverflow</a><br />
                <strong>Code:</strong> 1770+ <a href="https://phaser.io/examples">Examples</a> (source available in this <a href="https://github.com/photonstorm/phaser3-examples">repo</a>)<br />
                <strong>Discord:</strong> Join us on <a href="https://phaser.io/community/discord">Discord</a><br />
            ...
            <p>After 13 beta releases, over 200 resolved issues, thousands of lines of new code and the culmination of
                over 6 months incredibly hard work, Phaser 3.50 was finally released in December 2020 and we're kicking
                off the New Year with the 3.51 point release, which addresses a few issues and throws in a couple of new
                features.</p>
            <p>It's not hyperbole or exaggeration when I say that Phaser 3.50 is the single biggest point release ever
                in the history of Phaser. There are quite literally hundreds of new features to explore, updates to key
                areas and of course bug fixes. I did actually try counting all the changes, but gave up after I'd
                reached 900 of them! Thankfully, they are, as always, meticulously detailed in the <a
                    href="https://github.com/photonstorm/phaser/blob/master/CHANGELOG-v3.50.md">Change Log</a>. The
                changes for 3.50 actually grew so large that I had to split them out from the main Change Log and put
                them into their own file.</p>
            <p>However, don't let this overwhelm you. A massive number of the changes are purely internal and while
                there are absolutely some API breaking changes in this release (hence the large version number jump),
                we've kept them as sensible as possible. We already know of lots of devs who have upgraded with minimal,
            ...
            <p>There is plenty to be excited about in this version. It pulls together most of the R&amp;D that took
                place earlier this year for Phaser 4 and delivers it to you in version 3. New features include full
                support for post-processing effects via the new Post FX Pipeline, multi-texture support for faster WebGL
                rendering, a brand new Layer Game Object for the ability to group and post process objects without
                impacting their transforms, new event hooks, a massive overhaul of the Animation system, funky looking
                new Point Lights, a new Pipeline Manager, new Camera effects, the latest version of the Spine Plugin, an
                extremely powerful new Mesh Game Object, a brand new Render Texture, huge improvements to Bitmap Text,
            ...
            <p>As usual, I'd like to send my thanks to the Phaser community for their help in both reporting issues and
            ...
            <p>I'd like to send a massive thank-you to everyone who supports <a
                    href="https://www.patreon.com/photonstorm">Phaser on Patreon</a>, GitHub Sponsors and our corporate
                backers. Your continued funding allows me to keep working on Phaser full-time and this monster of a new
                release is the very real result of that. If you've ever considered becoming a backer, now is the perfect
                time!</p>
            ...
            <p>You can also follow Phaser on <a href="https://twitter.com/phaser_">Twitter</a> and chat with fellow
                Phaser devs in our <a href="https://phaser.io/community/discord">Discord</a>.</p>
            <p>Phaser 3 wouldn't have been possible without the fantastic support of the community and Patreon. Thank
                you to everyone who supports our work, who shares our belief in the future of HTML5 gaming, and Phaser's
                role in that.</p>
            ...
            <p>Those funds allow Phaser to improve, and when it improves, everyone involved benefits. Your support helps
            ...
            <p>We use <a href="https://www.patreon.com/photonstorm">Patreon</a> to manage the backing and you can <a
                ...
                like Netflix. You can, of course, cancel at any point. Tears will be shed on this end, but that's not
                your concern.</p>
            ...
            <ul>
                <li>Clone the git repository via <a href="https://github.com/photonstorm/phaser.git">https</a>, <a
                        href="git@github.com:photonstorm/phaser.git">ssh</a> or with the GitHub <a
...
@endmarkdown
            ...
            <p>Go to https://photonstorm.github.io/phaser3-docs/index.html to read the docs online. Use the drop-down
            ...
            <p>Or, if you wish to run the docs locally you can checkout the <a
                    href="https://github.com/photonstorm/phaser3-docs">phaser3-docs</a> repository and then read the
                documentation by pointing your browser to the <code>docs/</code> folder.</p>
            <p>The documentation for Phaser 3 is an on-going project. Please help us by contributing improved docs and
                examples.</p>
            <h3>TypeScript Definitions</h3>
            <p>The <a href="https://github.com/photonstorm/phaser/tree/master/types">TypeScript definitions</a> can be
...
@endmarkdown
            ...
            <p>We recently published a new <a
                    href="https://github.com/photonstorm/phaser3-typescript-project-template">Phaser 3 TypeScript
                    Project Template</a>, which you can use to get started with if you like.</p>
            <p>The TS defs are automatically generated from the JSDoc comments found in the Phaser source code. If you
                wish to help refine them then you must edit the Phaser JSDoc blocks directly, not the defs file. You can
                find more details about the parser we built in the <code>scripts/tsgen</code> folder.</p>
            <h3>Webpack</h3>
            <p>We use Webpack to build Phaser and we take advantage of its conditional build flag feature to handle
                renderer swapping. If you wish to use Webpack with Phaser then please use our <a
                    href="https://github.com/photonstorm/phaser3-project-template">Phaser 3 Project Template</a> as it's
                already set-up to handle the build conditions Phaser needs. Recent changes to our build steps mean you
            ...
            <ul>
                <li><a href="https://phaser.io/tutorials/getting-started-phaser3">Getting Started with Phaser 3</a>
                    (useful if you are completely new to Phaser)</li>
                <li><a href="https://phaser.io/tutorials/making-your-first-phaser-3-game">Making your first Phaser 3
                        Game</a></li>
                <li>The <a href="https://academy.zenva.com/product/html5-game-phaser-mini-degree/?a=13">Complete Phaser
                        3 Game Development course</a> contains over 15 hours of videos covering all kinds of important
                    topics.</li>
                <li>Plus, there are <a href="http://phaser.io/learn">over 700 Phaser tutorials</a> listed on the
                    official website.</li>
            </ul>
            <p>We've 3 tutorials related specifically to creating <strong>Facebook Instant Games</strong> with Phaser:
            </p>
            <ul>
                <li><a href="http://phaser.io/news/2018/10/facebook-instant-games-phaser-tutorial">Getting Started with
                ...
                <li><a href="http://phaser.io/news/2018/12/facebook-instant-games-ads-tutorial">Displaying Ads in your
                        Instant Games</a></li>
            </ul>
            <h3>Source Code Examples</h3>
            <p>During our development of Phaser 3, we created hundreds of examples with the full source code and assets
                ready available. These examples are now fully integrated into the <a
                    ...
                    href="https://labs.phaser.io">Phaser 3 Labs</a> via a more advanced interface, or clone the <a
                    href="https://github.com/photonstorm/phaser3-examples">examples repo</a>. We are constantly adding
            ...
            <p>Super community member RexRainbow has been publishing Phaser 3 content for years, building up an
                ...
                Machines and lots more. As well as the plugins there is also a comprehensive set of 'Notes' about Phaser
                3, going into great detail about how the various systems work. It's an invaluable resource and well
...
@endmarkdown
            ...
            <p>This is a standard empty webpage. You'll notice there's a script tag that is pulling in a build of Phaser
                3, but otherwise this webpage doesn't do anything yet. Now let's set-up the game config. Paste the
...
```
@endmarkdown
            <p><code>config</code> is a pretty standard Phaser 3 Game Configuration object. We tell <code>config</code>
                to use the WebGL renderer if it can, set the canvas to a size of 800x600 pixels, enable Arcade Physics,
                and finally call the <code>preload</code> and <code>create</code> functions. <code>preload</code> and
                <code>create</code> have not been implemented yet, so if you run this JavaScript code, you will have an
...
function create ()
{
            ...
            <p><code>game</code> is a Phaser Game instance that uses our configuration object <code>config</code>. We
                also add function definitions for <code>preload</code> and <code>create</code>. The <code>preload</code>
                function helps you easily load assets into your game. In <code>preload</code>, we set the Base URL to be
            ...
            <pre class="prettyprint source lang-javascript"><code>function create ()
{
    ...
    emitter.startFollow(logo);
            ...
            <p>Here we add a sky image into the game and create a Particle Emitter. The <code>scale</code> value means
                that the particles will initially be large and will shrink to nothing as their lifespan progresses.</p>
            <p>After creating the <code>emitter</code>, we add a logo image called <code>logo</code>. Since
                <code>logo</code> is a Physics Image, <code>logo</code> is given a physics body by default. We set some
                properties for <code>logo</code>: velocity, bounce (or restitution), and collision with the world
            ...
            <h3>Custom Builds</h3>
            <p>Phaser 3 is built using Webpack and we take advantage of the Webpack definePlugin feature to allow for
                conditional building of the Canvas and WebGL renderers and extra plugins. You can custom the build
                process to only include the features you require. Doing so can cut the main build file size down to just
                70KB.</p>
            <p>Read our <a
            ...
            <p>You can then run <code>webpack</code> to create a development build in the <code>build</code> folder
            ...
            <p>Traditionally we have always included the most recent Change Log in this README. It was a nice quick way
                for visitors to scan what's new in the latest version. However, with the 3.50.0 release we cannot do
            ...
            <p>We've organized the Change Log into commonly themed sections to make it more digestible, but we
                appreciate there is a lot in there. Please don't feel overwhelmed! If you need clarification about
            ...
            <ul>
                <li>
                    <p>Found a bug? Report it on <a href="https://github.com/photonstorm/phaser/issues">GitHub
                            Issues</a> and include a code sample. Please state which version of Phaser you are using!
                        This is vitally important.</p>
                </li>
                <li>
                    <p>Before submitting a Pull Request run your code through <a href="https://eslint.org/">ES Lint</a>
                        using our <a href="https://github.com/photonstorm/phaser/blob/master/.eslintrc.json">config</a>
                        and respect our <a href="https://github.com/photonstorm/phaser/blob/master/.editorconfig">Editor
                            Config</a>.</p>
                </li>
                <li>
                    <p>Before contributing read the <a
                            href="https://github.com/photonstorm/phaser/blob/master/.github/CODE_OF_CONDUCT.md">code of
                            conduct</a>.</p>
                </li>
            </ul>
            ...
            <div class="text-center">
                ...
                <p>Created by <a href="mailto:rich@photonstorm.com">Richard Davey</a>. Powered by coffee, anime, pixels and
                    love.</p>
                    <p>The Phaser logo and characters are © 2020 Photon Storm Limited.</p>
                    <p>All rights reserved.</p>
                    <p>&quot;Above all, video games are meant to be just one thing: fun. Fun for everyone.&quot; - Satoru Iwata
                    </p>
                </div>
            </article>
            </section>
