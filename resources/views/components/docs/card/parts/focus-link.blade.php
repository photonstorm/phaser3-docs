...
<div class="d-flex justify-content-end justify-content-md-end">
    ...
    <div class="copy-members-to-clipboard">
        <a href="#{{$collection->name}}" class="d-flex align-items-center align-middle"><img src="{{asset('images/hashtag.png')}}" alt="Focus" width="25" id="{{url()->to('')}}/{{Config::get('app.phaser_version')}}/focus/{{$collection->longname}}"></a>
    </div>
</div>
@endif
